...
deepspeed \
    ...
    --val_dataset mr_paco_val.json \
    --segmentation_config ./scripts/annotation_configs/train/paco_train.yaml \
    --conversation_config ./scripts/conversation_configs/train/mr_paco_train.yaml \
